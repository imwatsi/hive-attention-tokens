...
from hive_attention_tokens.utils.tools import SYSTEM_ACCOUNT
from hive_attention_tokens.utils.tools import normalize_json


class AttentionTokenV1:
    def __init__(self, parent, orig_acc, block_num, transaction_id, trans):
        ...
        if trn_name == 'gen':
            ...
            self.op = self.PostVote(parent,orig_acc, transaction_id,trans[2],trans[4])
        else:
